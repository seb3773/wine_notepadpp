#!/bin/bash
echo;echo;echo "  =========================";echo "  == Notepad++ for Linux =="
...
echo " > This script will install Notepad++ x64 on your computer."
...
WINEPREFIX="$HOME/.win64" wine "./files/npp.8.6.4.Installer.x64.exe"
...
sudo cp -f ./files/notepadpp.sh "$HOME/.win64"
sudo chmod +x "$HOME/.win64/notepadpp.sh"
